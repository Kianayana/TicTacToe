//This vasiable keeps track of whose turn it is. 
let activePlayer = 'X';
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/x22.png")';
    ...
    //This funcion results in random square being selected by the computer.
...
function disableClick() {
    //This makes our bpdy unclickable.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.stroke();
        //This conditipn checks i we've reached the endpoints.
        if (x1 <= x2 && y1 <= y2) {
